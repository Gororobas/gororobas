/**
 * @credits Overengineering Studio
 * @source https://github.com/overengineeringstudio/effect-utils/blob/main/packages/%40overeng/oxc-config/src/explicit-boolean-compare.ts
 *
...
const isBooleanNamingConvention = (name) => /^(is|has)[A-Z]/.test(name)
 ...
 */
const isKnownBooleanExpression = (node) => {

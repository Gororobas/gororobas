...
class CalculatorStateRef extends Context.Service<CalculatorStateRef, Ref.Ref<CalculatorState>>()(
  "CalculatorStateRef",
) {}
...
const CalculatorService = Context.Service<CalculatorService>("CalculatorService")

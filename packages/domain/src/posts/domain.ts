...
export const CorePostMetadata = Schema.Struct({
  ...
  publishedAt: Schema.NullishOr(Schema.DateFromString),
...
export const EventMetadata = Schema.Struct({
  ...
  endDate: Schema.NullishOr(Schema.DateFromString),
...
const CoreQueriedPostData = Schema.Struct({
  locale: Locale,
  tags: Schema.parseJson(Schema.Array(MatchedTag)),
  vegetables: Schema.parseJson(Schema.Array(MatchedVegetable)),
...
export const CreateEventData = Schema.Struct({
  ...
  content: TiptapDocument,
  endDate: Schema.optional(Schema.NullishOr(Schema.DateFromString)),
  handle: Handle,
...
export const PostCrdtRow = Schema.Struct({
  ...
  classification: Schema.NullishOr(Schema.parseJson(Schema.Unknown)),
  id: PostId,
...
export const PostCommitRow = Schema.Struct({
  ...
  fromCrdtFrontier: Schema.parseJson(LoroDocFrontier),
})
...
export const PostRow = Schema.Struct({
  ...TimestampedStruct.fields,
  attendanceMode: Schema.NullishOr(EventAttendanceMode),
  currentCrdtFrontier: Schema.parseJson(LoroDocFrontier),
  endDate: Schema.NullishOr(Schema.DateFromString),
  handle: Handle,
  id: PostId,
  locationOrUrl: Schema.NullishOr(Schema.String),
  ownerProfileId: ProfileId,
  publishedAt: Schema.NullishOr(Schema.DateFromString),
  startDate: Schema.NullishOr(Schema.DateFromString),
  kind: PostKind,
...
export const PostTranslationRow = Schema.Struct({
  ...
  originalLocale: Locale,
  postId: PostId,
  translatedAtCrdtFrontier: Schema.parseJson(LoroDocFrontier),
  translationSource: TranslationSource,
})

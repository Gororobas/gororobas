Feature: Resources
  ...
  Rule: Resources support translations
    ...
    Background:
      ...
      And the resource "A Terra Dá, a Terra Quer" exists with pt title "A Terra Dá, a Terra Quer"

    Scenario: Add translation to another locale
      Given "Maria" has submitted a es translation for resource "A Terra Dá, a Terra Quer" with title "La Tierra Da, La Tierra Quiere"
      When the revision is APPROVED
      Then resource "A Terra Dá, a Terra Quer" has es title "La Tierra Da, La Tierra Quiere"

    Scenario: Viewing resource in unsupported locale falls back to original
      Given resource "A Terra Dá, a Terra Quer" has only pt title "A Terra Dá, a Terra Quer"
      When a user with es locale views resource "A Terra Dá, a Terra Quer"

...
CREATE TABLE `comment_crdts` (
  ...
  CONSTRAINT `2` FOREIGN KEY (`publication_id`) REFERENCES `publication_crdts` (`id`) ON UPDATE NO ACTION ON DELETE CASCADE
);
...
CREATE TABLE `comments` (
  ...
  PRIMARY KEY (`id`),
  CONSTRAINT `0` FOREIGN KEY (`publication_id`) REFERENCES `publication_crdts` (`id`) ON UPDATE NO ACTION ON DELETE CASCADE,
  CONSTRAINT `1` FOREIGN KEY (`owner_profile_id`) REFERENCES `profiles` (`id`) ON UPDATE NO ACTION ON DELETE CASCADE,
  CONSTRAINT `2` FOREIGN KEY (`id`) REFERENCES `comment_crdts` (`id`) ON UPDATE NO ACTION ON DELETE CASCADE
);
...
-- Create "bookmarks_wiki_articles" table

...
// This file was autogenerated by `migrate.ts` based on `src/db/migrations-sql/20260824165522_initial.sql`
...
CREATE TABLE \`wiki_article_translations\` (
  ...
  yield* sql`-- Create "wiki_article_handles" table
CREATE TABLE \`wiki_article_handles\` (
  ...
  yield* sql`-- Create index "wiki_article_handles_kind_handle" to table: "wiki_article_handles"
CREATE UNIQUE INDEX \`wiki_article_handles_kind_handle\` ON \`wiki_article_handles\` (\`kind\`, \`handle\`)`

  yield* sql`-- Create "wiki_article_photos" table
CREATE TABLE \`wiki_article_photos\` (
  ...
  yield* sql`-- Create "wiki_article_photo_metadata" table
...
CREATE TABLE \`publication_tags\` (
  ...
  yield* sql`-- Create "publication_wiki_articles" table
...
CREATE TABLE \`comment_translations\` (
  ...
  yield* sql`-- Create "bookmarks_wiki_articles" table

...
export namespace $default {
  export interface AdminCanDoAnything extends std.$Object {}
  export interface Auditable extends std.$Object {
    "created_at"?: Date | null;
    "updated_at"?: Date | null;
    "created_by"?: UserProfile | null;
  }
  export interface BlueskyPost extends Auditable, AdminCanDoAnything {
    "text": string;
    "content": PostableToBluesky;
  }
  export type EdiblePart = "FRUTO" | "FLOR" | "FOLHA" | "CAULE" | "SEMENTE" | "CASCA" | "BULBO" | "BROTO" | "RAIZ" | "TUBERCULO" | "RIZOMA";
  export interface UserCanInsert extends std.$Object {}
  export interface PublicRead extends std.$Object {}
  export interface ModeratorCanUpdate extends std.$Object {}
  export interface EditSuggestion extends Auditable, AdminCanDoAnything, UserCanInsert, PublicRead, ModeratorCanUpdate {
    "diff": unknown;
    "snapshot": unknown;
  ...
  export type EditSuggestionStatus = "PENDING_REVIEW" | "MERGED" | "REJECTED";
  export type Gender = "FEMININO" | "MASCULINO" | "NEUTRO";
  export type HistoryAction = "INSERT" | "UPDATE" | "DELETE";
  export interface HistoryLog extends std.$Object {
    "performed_by"?: UserProfile | null;
    "target"?: Auditable | null;
    "action": HistoryAction;
    "old"?: unknown | null;
    "timestamp"?: Date | null;
    "new"?: unknown | null;
  }
  export interface UserCanUpdate extends std.$Object {}
  export interface Image extends PublicRead, Auditable, UserCanInsert, UserCanUpdate, AdminCanDoAnything {
    "crop"?: unknown | null;
  ...
  export interface WithHandle extends std.$Object {
    "handle": string;
  }
  export interface PostableToBluesky extends std.$Object {
    "has_been_posted_to_bluesky": boolean;
  }
  export interface Note extends WithHandle, Auditable, AdminCanDoAnything, PostableToBluesky {
    "public": boolean;
    "publish_status": NotePublishStatus;
    "related_to_notes": Note[];
    "related_notes": Note[];
    "body"?: unknown | null;
    ...
    "title": unknown;
    "types": NoteType[];
    "related_to_vegetables": Vegetable[];
  }
  export type NotePublishStatus = "PRIVATE" | "COMMUNITY" | "PUBLIC";
  export type NoteType = "EXPERIMENTO" | "ENSINAMENTO" | "DESCOBERTA" | "PERGUNTA" | "INSPIRACAO";
  export type PlantingMethod = "BROTO" | "ENXERTO" | "ESTACA" | "RIZOMA" | "SEMENTE" | "TUBERCULO";
  export interface WithTags extends std.$Object {
    "tags": Tag[];
  }
  export interface Resource extends WithHandle, WithTags, PublicRead, Auditable, UserCanInsert, AdminCanDoAnything, PostableToBluesky {
    ...
    "title": string;
    "url": string;
    "related_vegetables": Vegetable[];
  }
  export type ResourceFormat = "BOOK" | "FILM" | "SOCIAL_MEDIA" | "VIDEO" | "ARTICLE" | "PODCAST" | "COURSE" | "ACADEMIC_WORK" | "DATASET" | "ORGANIZATION" | "OTHER";
  export type Role = "ADMIN" | "USER" | "MODERATOR";
  export interface Source extends Auditable, PublicRead, UserCanInsert, AdminCanDoAnything, UserCanUpdate {
  ...
  export type SourceType = "GOROROBAS" | "EXTERNAL";
  export type Stratum = "EMERGENTE" | "ALTO" | "MEDIO" | "BAIXO" | "RASTEIRO";
  export interface Tag extends WithHandle, PublicRead, AdminCanDoAnything {
    "category"?: string | null;
    "description"?: unknown | null;
    "names": string[];
    "mentions": WithTags[];
  }
  export type TipSubject = "PLANTIO" | "CRESCIMENTO" | "COLHEITA";
  ...
  export interface UserCanSelect extends std.$Object {}
  export interface UserProfile extends WithHandle, PublicRead {
    "user"?: User | null;
    "photo"?: Image | null;
    "bio"?: unknown | null;
  ...
  export interface UserWishlist extends PublicRead {
    "user_profile": UserProfile;
    "vegetable": Vegetable;
    "status": VegetableWishlistStatus;
  }
  export interface Vegetable extends WithHandle, PublicRead, Auditable, UserCanInsert, AdminCanDoAnything, ModeratorCanUpdate, PostableToBluesky {
    ...
    "edible_parts": EdiblePart[];
    "gender"?: Gender | null;
    "height_max"?: number | null;
    "height_min"?: number | null;
    "lifecycles": VegetableLifeCycle[];
    "origin"?: string | null;
    "planting_methods": PlantingMethod[];
    "strata": Stratum[];
    ...
    "wishlisted_by": UserWishlist[];
  }
  export interface VegetableFriendship extends Auditable, PublicRead, UserCanInsert, AdminCanDoAnything {
    "vegetables": Vegetable[];
    "unique_key": string;
  }
  export type VegetableLifeCycle = "SEMESTRAL" | "ANUAL" | "BIENAL" | "PERENE";
  export interface VegetableTip extends WithHandle, PublicRead, Auditable, UserCanInsert, AdminCanDoAnything {
    "content": unknown;
    "subjects": TipSubject[];
    "sources": Source[];
  }
  export type VegetableUsage = "ALIMENTO_ANIMAL" | "ALIMENTO_HUMANO" | "CONSTRUCAO" | "MATERIA_ORGANICA" | "MEDICINAL" | "COSMETICO" | "ORNAMENTAL" | "RITUALISTICO" | "ECOLOGICO";
  export interface VegetableVariety extends WithHandle, PublicRead, Auditable, UserCanInsert, AdminCanDoAnything {
    "names": string[];
    "photos": Image[];
  }
  export type VegetableWishlistStatus = "QUERO_CULTIVAR" | "SEM_INTERESSE" | "JA_CULTIVEI" | "ESTOU_CULTIVANDO";
  export interface current_user extends User {}
  export interface current_user_profile extends UserProfile {}
}
export type AdminCanDoAnything = $default.AdminCanDoAnything;
export type Auditable = $default.Auditable;
export type BlueskyPost = $default.BlueskyPost;
export type EdiblePart = $default.EdiblePart;
export type UserCanInsert = $default.UserCanInsert;
export type PublicRead = $default.PublicRead;
export type ModeratorCanUpdate = $default.ModeratorCanUpdate;
export type EditSuggestion = $default.EditSuggestion;
export type EditSuggestionStatus = $default.EditSuggestionStatus;
export type Gender = $default.Gender;
export type HistoryAction = $default.HistoryAction;
export type HistoryLog = $default.HistoryLog;
export type UserCanUpdate = $default.UserCanUpdate;
export type Image = $default.Image;
export type WithHandle = $default.WithHandle;
export type PostableToBluesky = $default.PostableToBluesky;
export type Note = $default.Note;
export type NotePublishStatus = $default.NotePublishStatus;
export type NoteType = $default.NoteType;
export type PlantingMethod = $default.PlantingMethod;
export type WithTags = $default.WithTags;
export type Resource = $default.Resource;
export type ResourceFormat = $default.ResourceFormat;
export type Role = $default.Role;
export type Source = $default.Source;
export type SourceType = $default.SourceType;
export type Stratum = $default.Stratum;
export type Tag = $default.Tag;
export type TipSubject = $default.TipSubject;
export type User = $default.User;
export type UserCanSelect = $default.UserCanSelect;
export type UserProfile = $default.UserProfile;
export type UserWishlist = $default.UserWishlist;
export type Vegetable = $default.Vegetable;
export type VegetableFriendship = $default.VegetableFriendship;
export type VegetableLifeCycle = $default.VegetableLifeCycle;
export type VegetableTip = $default.VegetableTip;
export type VegetableUsage = $default.VegetableUsage;
export type VegetableVariety = $default.VegetableVariety;
export type VegetableWishlistStatus = $default.VegetableWishlistStatus;
export type current_user = $default.current_user;
export type current_user_profile = $default.current_user_profile;
...
export interface types {
  ...
  "default": {
    "AdminCanDoAnything": $default.AdminCanDoAnything;
    "Auditable": $default.Auditable;
    "BlueskyPost": $default.BlueskyPost;
    "EdiblePart": $default.EdiblePart;
    "UserCanInsert": $default.UserCanInsert;
    "PublicRead": $default.PublicRead;
    "ModeratorCanUpdate": $default.ModeratorCanUpdate;
    "EditSuggestion": $default.EditSuggestion;
    "EditSuggestionStatus": $default.EditSuggestionStatus;
    "Gender": $default.Gender;
    "HistoryAction": $default.HistoryAction;
    "HistoryLog": $default.HistoryLog;
    "UserCanUpdate": $default.UserCanUpdate;
    "Image": $default.Image;
    "WithHandle": $default.WithHandle;
    "PostableToBluesky": $default.PostableToBluesky;
    "Note": $default.Note;
    "NotePublishStatus": $default.NotePublishStatus;
    "NoteType": $default.NoteType;
    "PlantingMethod": $default.PlantingMethod;
    "WithTags": $default.WithTags;
    "Resource": $default.Resource;
    "ResourceFormat": $default.ResourceFormat;
    "Role": $default.Role;
    "Source": $default.Source;
    "SourceType": $default.SourceType;
    "Stratum": $default.Stratum;
    "Tag": $default.Tag;
    "TipSubject": $default.TipSubject;
    "User": $default.User;
    "UserCanSelect": $default.UserCanSelect;
    "UserProfile": $default.UserProfile;
    "UserWishlist": $default.UserWishlist;
    "Vegetable": $default.Vegetable;
    "VegetableFriendship": $default.VegetableFriendship;
    "VegetableLifeCycle": $default.VegetableLifeCycle;
    "VegetableTip": $default.VegetableTip;
    "VegetableUsage": $default.VegetableUsage;
    "VegetableVariety": $default.VegetableVariety;
    "VegetableWishlistStatus": $default.VegetableWishlistStatus;
    "current_user": $default.current_user;
    "current_user_profile": $default.current_user_profile;
  };
  "ext": {
    "auth": {

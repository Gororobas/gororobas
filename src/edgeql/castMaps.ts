...
import type * as _$default from "./modules/default";
...
export interface ScalarAssignableByMap {
  ...
  "ext::auth::WebhookEvent": _extauth.$WebhookEvent;
  "ext::auth::JWTAlgo": _extauth.$JWTAlgo;
  "ext::auth::FlowType": _extauth.$FlowType;
  "default::VegetableWishlistStatus": _$default.$VegetableWishlistStatus;
  "default::VegetableUsage": _$default.$VegetableUsage;
  "default::VegetableLifeCycle": _$default.$VegetableLifeCycle;
  "default::TipSubject": _$default.$TipSubject;
  "default::Stratum": _$default.$Stratum;
  "default::SourceType": _$default.$SourceType;
  "default::Role": _$default.$Role;
  "default::ResourceFormat": _$default.$ResourceFormat;
  "default::PlantingMethod": _$default.$PlantingMethod;
  "default::NoteType": _$default.$NoteType;
  "default::NotePublishStatus": _$default.$NotePublishStatus;
  "default::HistoryAction": _$default.$HistoryAction;
  "default::Gender": _$default.$Gender;
  "default::EditSuggestionStatus": _$default.$EditSuggestionStatus;
  "default::EdiblePart": _$default.$EdiblePart;
...
function getSharedParentScalar<A extends $.ScalarType, B extends $.ScalarType>(a: A, b: B): A | B {
  ...
  if (a.__name__ === "default::VegetableWishlistStatus") {
    if(b.__name__ === "default::VegetableWishlistStatus") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::VegetableUsage") {
    if(b.__name__ === "default::VegetableUsage") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::VegetableLifeCycle") {
    if(b.__name__ === "default::VegetableLifeCycle") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::TipSubject") {
    if(b.__name__ === "default::TipSubject") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::Stratum") {
    if(b.__name__ === "default::Stratum") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::SourceType") {
    if(b.__name__ === "default::SourceType") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  ...
  if (a.__name__ === "default::ResourceFormat") {
    if(b.__name__ === "default::ResourceFormat") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::PlantingMethod") {
    if(b.__name__ === "default::PlantingMethod") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::NoteType") {
    if(b.__name__ === "default::NoteType") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::NotePublishStatus") {
    if(b.__name__ === "default::NotePublishStatus") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::HistoryAction") {
    if(b.__name__ === "default::HistoryAction") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::Gender") {
    if(b.__name__ === "default::Gender") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::EditSuggestionStatus") {
    if(b.__name__ === "default::EditSuggestionStatus") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::EdiblePart") {
    if(b.__name__ === "default::EdiblePart") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }

...
} & $.EnumType<"sys::OutputFormat", ["BINARY", "JSON", "JSON_ELEMENTS", "NONE"]>;
const OutputFormat: $OutputFormat = $.makeType<$OutputFormat>(_.spec, "cae65a8c-a99f-5524-9872-daecdc545531", _.syntax.literal);

export type $QueryType = {
  "EdgeQL": $.$expr_Literal<$QueryType>;
  "SQL": $.$expr_Literal<$QueryType>;
} & $.EnumType<"sys::QueryType", ["EdgeQL", "SQL"]>;
const QueryType: $QueryType = $.makeType<$QueryType>(_.spec, "f2887f6f-bd51-5422-8ac7-d1732fdcd17d", _.syntax.literal);
...
const TransactionAccessMode: $TransactionAccessMode = $.makeType<$TransactionAccessMode>(_.spec, "775fc501-0b35-57fa-8587-cd7c53557cdf", _.syntax.literal);
...
} & $.EnumType<"sys::TransactionDeferrability", ["Deferrable", "NotDeferrable"]>;
const TransactionDeferrability: $TransactionDeferrability = $.makeType<$TransactionDeferrability>(_.spec, "2eb021ec-461e-5b65-859c-26c1eee234a1", _.syntax.literal);
...
], "sys::Branch" | "sys::Database" | "sys::ExtensionPackage" | "sys::ExtensionPackageMigration" | "sys::QueryStats" | "sys::Role">;
...
export type $BranchλShape = $.typeutil.flatten<$ExternalObjectλShape & _schema.$AnnotationSubjectλShape & {
  "name": $.PropertyDesc<_std.$str, $.Cardinality.One, true, false, false, false>;
  "last_migration": $.PropertyDesc<_std.$str, $.Cardinality.AtMostOne, false, false, false, false>;
  "<branch[is sys::QueryStats]": $.LinkDesc<$QueryStats, $.Cardinality.Many, {}, false, false,  false, false>;
  "<branch": $.LinkDesc<$.ObjectType, $.Cardinality.Many, {}, false, false,  false, false>;
}>;
type $Branch = $.ObjectType<"sys::Branch", $BranchλShape, null, [
...
const $Branch = $.makeType<$Branch>(_.spec, "2572fefc-1810-5379-bc6e-af9b8cf3943b", _.syntax.literal);
...
export type $ExtensionPackageMigrationλShape = $.typeutil.flatten<$SystemObjectλShape & _schema.$AnnotationSubjectλShape & {
  "script": $.PropertyDesc<_std.$str, $.Cardinality.One, false, false, false, false>;
  "from_version": $.PropertyDesc<$.NamedTupleType<{major: _std.$int64, minor: _std.$int64, stage: $VersionStage, stage_no: _std.$int64, local: $.ArrayType<_std.$str>}>, $.Cardinality.One, false, false, false, false>;
  "to_version": $.PropertyDesc<$.NamedTupleType<{major: _std.$int64, minor: _std.$int64, stage: $VersionStage, stage_no: _std.$int64, local: $.ArrayType<_std.$str>}>, $.Cardinality.One, false, false, false, false>;
}>;
type $ExtensionPackageMigration = $.ObjectType<"sys::ExtensionPackageMigration", $ExtensionPackageMigrationλShape, null, [
  ...$SystemObject['__exclusives__'],
  ..._schema.$AnnotationSubject['__exclusives__'],
], "sys::ExtensionPackageMigration">;
const $ExtensionPackageMigration = $.makeType<$ExtensionPackageMigration>(_.spec, "e3aaabec-f88b-5fe0-b06e-cea0b3d46fa8", _.syntax.literal);
...
export type $QueryStatsλShape = $.typeutil.flatten<$ExternalObjectλShape & {
  ...
  "compilation_config": $.PropertyDesc<_std.$json, $.Cardinality.AtMostOne, false, false, false, false>;
  "protocol_version": $.PropertyDesc<$.NamedTupleType<{major: _std.$int16, minor: _std.$int16}>, $.Cardinality.AtMostOne, false, false, false, false>;
  "default_namespace": $.PropertyDesc<_std.$str, $.Cardinality.AtMostOne, false, false, false, false>;
  "namespace_aliases": $.PropertyDesc<_std.$json, $.Cardinality.AtMostOne, false, false, false, false>;
  "output_format": $.PropertyDesc<$OutputFormat, $.Cardinality.AtMostOne, false, false, false, false>;
  "expect_one": $.PropertyDesc<_std.$bool, $.Cardinality.AtMostOne, false, false, false, false>;
  "implicit_limit": $.PropertyDesc<_std.$int64, $.Cardinality.AtMostOne, false, false, false, false>;
  "inline_typeids": $.PropertyDesc<_std.$bool, $.Cardinality.AtMostOne, false, false, false, false>;
  "inline_typenames": $.PropertyDesc<_std.$bool, $.Cardinality.AtMostOne, false, false, false, false>;
  "inline_objectids": $.PropertyDesc<_std.$bool, $.Cardinality.AtMostOne, false, false, false, false>;
  "plans": $.PropertyDesc<_std.$int64, $.Cardinality.AtMostOne, false, false, false, false>;
  "total_plan_time": $.PropertyDesc<_std.$duration, $.Cardinality.AtMostOne, false, false, false, false>;
  "min_plan_time": $.PropertyDesc<_std.$duration, $.Cardinality.AtMostOne, false, false, false, false>;
  "max_plan_time": $.PropertyDesc<_std.$duration, $.Cardinality.AtMostOne, false, false, false, false>;
  "mean_plan_time": $.PropertyDesc<_std.$duration, $.Cardinality.AtMostOne, false, false, false, false>;
  "stddev_plan_time": $.PropertyDesc<_std.$duration, $.Cardinality.AtMostOne, false, false, false, false>;
  "calls": $.PropertyDesc<_std.$int64, $.Cardinality.AtMostOne, false, false, false, false>;
  "total_exec_time": $.PropertyDesc<_std.$duration, $.Cardinality.AtMostOne, false, false, false, false>;
  "min_exec_time": $.PropertyDesc<_std.$duration, $.Cardinality.AtMostOne, false, false, false, false>;
  "max_exec_time": $.PropertyDesc<_std.$duration, $.Cardinality.AtMostOne, false, false, false, false>;
...
const $QueryStats = $.makeType<$QueryStats>(_.spec, "ce92490c-1d17-5950-8bdd-cf9e23817551", _.syntax.literal);

const QueryStats: $.$expr_PathNode<$.TypeSet<$QueryStats, $.Cardinality.Many>, null> = _.syntax.$PathNode($.$toSet($QueryStats, $.Cardinality.Many), null);
...
> = $.$expr_Function<
  _std.$datetime, $.cardutil.overrideLowerBound<$.cardutil.multiplyCardinalities<$.cardutil.multiplyCardinalities<$.cardutil.optionalParamCardinality<NamedArgs["branch_name"]>, $.cardutil.optionalParamCardinality<NamedArgs["id"]>>, $.cardutil.optionalParamCardinality<NamedArgs["minmax_only"]>>, "Zero">
>;
/**
...
>(
  namedArgs: NamedArgs,
): reset_query_statsλFuncExpr<NamedArgs>;
function reset_query_stats(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('sys::reset_query_stats', args, _.spec, [

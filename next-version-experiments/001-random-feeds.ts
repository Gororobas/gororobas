import { randParagraph, randFullName, randNumber, randCat, seed } from '@ngneat/falso';
...
db.run("CREATE TABLE cats (id INTEGER PRIMARY KEY, name TEXT, age INTEGER, description TEXT)");
console.timeEnd("Setting up database")

const insertCat = db.prepare("INSERT INTO cats (name, age, description) VALUES ($name, $age, $description)");

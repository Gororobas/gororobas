...
-- Create index "user_profiles_handle" to table: "user_profiles"
CREATE UNIQUE INDEX `user_profiles_handle` ON `user_profiles` (`handle`);
-- Create index "idx_user_profiles_handle" to table: "user_profiles"
...
-- Create index "vegetable_translations_locale_handle" to table: "vegetable_translations"
CREATE UNIQUE INDEX `vegetable_translations_locale_handle` ON `vegetable_translations` (`locale`, `handle`);
-- Create index "idx_vegetables_handle" to table: "vegetable_translations"
...
-- Create "vegetable_friendships" table
...
-- Create index "vegetable_friendships_unique_key" to table: "vegetable_friendships"
...
-- Create index "notes_handle" to table: "notes"
CREATE UNIQUE INDEX `notes_handle` ON `notes` (`handle`);
-- Create index "idx_notes_handle" to table: "notes"
CREATE INDEX `idx_notes_handle` ON `notes` (`handle`);
-- Create "note_translations" table
